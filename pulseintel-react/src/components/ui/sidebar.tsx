  ...
  (
    ...
    if (isMobile) {
      return (
        <div
          className={cn(
            "fixed inset-y-0 z-50 flex h-svh w-[--sidebar-width] flex-col bg-sidebar p-0 text-sidebar-foreground transition-transform duration-300 ease-in-out",
...
>(
  (
    ...
    // removed unused useSidebar() call
